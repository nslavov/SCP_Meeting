...
#SCPday1 td, #SCPday1 th {
  border: 1px solid #ddd;
  padding: 8px;
}

table#SCPday1 tr:nth-child(even){background-color: #f2f2f2;}

table#SCPday1 tr:hover {background-color: #ddd;}
...
<tr style="background-color: #f2f2f2;"><td> Nikolai Slavov, Northeastern University </td><td> Opening remarks </td><td> 9:00 </td><td> 13:00 </td><td> <script> var strDateTime = "Tue, 18 Aug 2020  13:00  GMT"; var myDate = new Date(strDateTime); document.write( myDate.toLocaleString() ); </script> </td></tr>
